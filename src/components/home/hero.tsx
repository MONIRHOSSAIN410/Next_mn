  ...
  return (
    <section className="bg-chrome relative isolate overflow-hidden">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        <motion.div
          className="bg-brand/25 absolute -top-40 -left-32 size-[34rem] rounded-full blur-[110px]"
          animate={reduced ? undefined : { x: [0, 60, 0], y: [0, 40, 0] }}
          transition={{ duration: 18, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.div
          className="bg-brand-soft/20 absolute -right-24 -bottom-40 size-[30rem] rounded-full blur-[120px]"
            ...
            >
              ...
              {product && (
                <motion.div
                  ...
                  className="glass absolute right-0 bottom-2 left-0 mx-auto w-[90%] rounded-xl border p-3.5 shadow-xl"
                >
